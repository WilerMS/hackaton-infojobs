export const InfoJobsIcon = () => {
  return (
    <svg style={{ width: '35px' }} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 138 136.054" xmlSpace="preserve">
      <path style={{ fill: '#2088c2' }} d="M138 112.968c0 12.75-10.335 23.086-23.085 23.086h-91.83C10.336 136.054 0 125.719 0 112.968V23.086C0 10.336 10.336 0 23.085 0h91.83C127.665 0 138 10.336 138 23.086v89.882z"></path>
